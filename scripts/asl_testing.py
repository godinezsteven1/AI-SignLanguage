...
# Constants
IMG_SIZE = 224  # Same as in the model training code
...
def main():
    ...
    # Load model
    model_path = "../models/improved_asl_model.h5"  # Update path as needed
    ...
    while running:
        ...
        processed_frame = cv2.resize(processed_frame[0], (IMG_SIZE, IMG_SIZE))  # Resize to (224, 224)
