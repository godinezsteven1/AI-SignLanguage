        ...
        for class_name in sorted(os.listdir(data_dir)):
            ...
            for file in sampled_files:
                ...
                if processed_img is not None:
                    ...
                    cv2.imwrite(os.path.join(output_class_dir, f"flipped_{file}"), flipped_img)
...
class CombinedDataGenerator(tf.keras.utils.Sequence):
    def __init__(self, data, batch_size, is_training=True):
        ...
        # Add image augmentation generator for training only
        if self.is_training:
    ...
    def __getitem__(self, idx):
        ...
        for i, (class_path, image_file) in enumerate(batch_indices):
            ...
            img = cv2.resize(img, (IMG_SIZE, IMG_SIZE))  # Just in case
...
# Save model
model.save('../models/full_model_flipped.h5')